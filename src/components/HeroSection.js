...
{/* Enjoy Your Online  <br/> 
<p className='text-blue-900'>Shoping</p>  */}
      </h2>
       <p className="text-2xl text-gray-500 mt-3">{t('welcome.subtitle')}</p> 

{/* <br/>

      <p className='text-2xl text-gray-500 mt-3'> {t('Welcome to React')}
      <br/>
       This Shoping website include everything that you <strong>Need</strong>, 
      <br/> you can find all Your <strong>wants and demands</strong> , feel free to watch products 
      </p> */}
